...
Also assume that the right side is held at a constant zero degrees and the left side has a temperature profile of $y(10-y)$\todo{Is the left side held constant at these values?}.
