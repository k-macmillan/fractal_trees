...
The values used to generate the patterns in \autoref{prob5:fig:results} are summarized in \autoref{prob5:tab:parameters}.\todo{Update these values before turning in the final version of the paper.}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}llllll@{}}
        \toprule
        % TODO: Update these values from the Makefile once they're finalized.
